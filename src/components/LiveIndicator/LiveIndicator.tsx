      ...
      <div className='inline-block cursor-pointer mx-1' onClick={toggle}>
        {isLive ? (
          <span className='relative flex h-3 w-3'>
            <span className='animate-ping absolute inline-flex h-full w-full rounded-full bg-go-down opacity-75'></span>
            <span className='relative inline-flex rounded-full h-3 w-3 bg-go-down'></span>
          </span>
        ) : (
